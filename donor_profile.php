...
<body>
  <!-- Back Button -->
  <a href="donor_homepage.php" class="back-btn">&#11013;</a>

  <header>
    <div class="brand">
      <div class="logo"><img src="images/circle-logo.png" alt="Smart Aid logo"></div>
      <div>
        <div style="font-weight:700;color:white">Smart Aid</div>
        <div class="muted" style="font-size:13px;color:rgba(255,255,255,0.9)">Donor profile</div>
      </div>
    </div>
      ...
      <div style="margin-top:18px">
        ...
        <div id="socialBox" class="small-card">
          <div style="display:flex;flex-direction:column;gap:8px">
            <div id="socialLinksContainer" class="socials">
              <!-- (future) social links coming from DB -->
            </div>
  ...
  <!-- keeping modal HTML for future real editing; not used now -->
  <div id="modalEdit" class="modal-backdrop" role="dialog" aria-modal="true"
    ...
    <div class="modal" role="document"
      ...
      <!-- original modal content kept unchanged -->
      <!-- You can later hook this up to a real update endpoint -->
      <h3 style="margin-top:0">Edit profile</h3>
      <!-- ... (all your existing modal inner HTML stays as it was) ... -->
      <!-- To keep this answer short, you can paste your original modal inner content here unchanged -->
    </div>
  </div>
  ...
  <script>
    ...
    // Edit profile button → go to settings page (backend page for updating user row)
    document.getElementById('editProfileBtn').addEventListener('click', function () {
      window.location.href = 'donor-settings.php';
    });
  </script>
</body>
</html>
